...
namespace ModularWebService.WebApi
{
    internal static class SwaggerDocumentation
    {
        ...
        {
            app.UseSwagger();
            app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1.0/swagger.json", "ModularWebService API V1.0"); });
        }
